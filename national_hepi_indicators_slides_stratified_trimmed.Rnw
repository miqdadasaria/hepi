...
<<external-code, cache=FALSE, include=FALSE>>=
	...
	## CCG
	##geo_name="NHS Hull"#"NHS Vale of York"#
	##geo="CCG"

	## LAT
	#geo_name = c("North Yorkshire and Humber")
	#geo = "LAT"
...
\author{Miqdad Asaria, Shehzad Ali, Richard Cookson}
\institute{\textcolor{red}{Work in progress not for citation}}
...
\begin{center}
\begin{itemize}
    \item This is unpublished work-in-progress arising from the research project:
\textit{Cookson, R, Raine, R, Laudicella, M, Goddard, M, Ferguson, B,
Fleetcroft, R, Goldblatt, P.  Jan 2013 to Dec 2015.  Developing indicators of change in NHS equity performance. NIHR Health Services and Delivery Research (HS&DR) Programme (project number 11/2004/39).}
    \item Please do not cite any of the findings in this document, as they have not been peer reviewed and are subject to change and revision as the project proceeds.
  \end{itemize}
\end{center}
\end{frame}
...
%\subsection{5. Post-hospital Adverse Events}
%
%\begin{frame}[containsverbatim]
%\frametitle{Indicator 5. Post-hospital adverse events}
%Post-hospital adverse events
%\begin{center}
%  \begin{itemize}
%    \item proportion of inpatients with subsequent emergency readmission or death the same year
%    \item adjusted for age and sex
%  \end{itemize}
%\end{center}
%\end{frame}
...
%\frametitle{Equity scatterplot}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}adverse_event_adj_2011_scatter.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity trend chart unadjusted}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}adverse_event_panel.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity trend chart}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}adverse_event_adj_panel.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity matrix plot}
%\begin{center}
%\includegraphics{\Sexpr{national_parent_dir}adverse_event_matrix_fixed.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity matrix plot (free axis between age groups)}
%\begin{center}
%\includegraphics{\Sexpr{national_parent_dir}adverse_event_matrix_free.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity caterpillar plot at \Sexpr{geo} level}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}adverse_event_adj_2011_caterpillar.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Top 10 \Sexpr{geo}s (1 = best on equity)}
%\begin{center}
%\input{\Sexpr{geo_parent_dir}adverse_event_adj_top_ten_table}
%\end{center}
%\end{frame}			
%
%\begin{frame}[containsverbatim]
%\frametitle{Bottom 10 \Sexpr{geo}s (1 = worst on equity)}
%\begin{center}
%\input{\Sexpr{geo_parent_dir}adverse_event_adj_bottom_ten_table}
%\end{center}
%\end{frame}	
...
%\subsection{9. Morbidity}
%
%\begin{frame}[containsverbatim]
%\frametitle{Indicator 9. Morbidity}
%Morbidity
%\begin{center}
%\begin{itemize}
%    \item proportion of people with one or more condition (based on quality and outcomes framework data)
%  \end{itemize}
%\end{center}
%\end{frame}
%
...
%\frametitle{Equity scatterplot}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}morbidity_2011_scatter.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity trend chart}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}morbidity_panel.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Equity caterpillar plot at \Sexpr{geo} level}
%\begin{center}
%\includegraphics{\Sexpr{national_dir}morbidity_2011_caterpillar.png}
%\end{center}
%\end{frame}
%
%\begin{frame}[containsverbatim]
%\frametitle{Top 10 \Sexpr{geo}s (1 = best on equity)}
%\begin{center}
%\input{\Sexpr{geo_parent_dir}morbidity_top_ten_table}
%\end{center}
%\end{frame}			
%
%\begin{frame}[containsverbatim]
%\frametitle{Bottom 10 \Sexpr{geo}s (1 = worst on equity)}
%\begin{center}
%\input{\Sexpr{geo_parent_dir}morbidity_bottom_ten_table}
%\end{center}
%\end{frame}
